    ...
    public class LawyerInfoController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var model = new LawyerViewModel
            {
                ...
                Reviews = _context.Requests.Include(r => r.User).Where(r => r.ReviewStatus == "Reviewed").Where(l => l.LawyerId == id).ToList()
            };
            return View(model);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LawyerId,Specialization,OfficeNumber,OfficeLocation,Information,JopDescription,UserId")] LawyerInfo lawyerInfo)
        {
